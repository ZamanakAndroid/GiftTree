package com.zamanak.shamimsalamat.fragment;
...
import com.zamanak.shamimsalamat.activity.TryChanceActivity;
import com.zamanak.shamimsalamat.adapter.ChanceTreeAdapter;
...
import com.zamanak.shamimsalamat.api.Urls;
import com.zamanak.shamimsalamat.api.request.RequestGetPageDetail;
import com.zamanak.shamimsalamat.api.request.RequestGetWinnersArround;
import com.zamanak.shamimsalamat.api.result.RecentWinners;
import com.zamanak.shamimsalamat.api.result.ResultDetailRes;
import com.zamanak.shamimsalamat.api.result.ResultGetDetailRes;
import com.zamanak.shamimsalamat.api.result.ResultGetWinnersArround;
import com.zamanak.shamimsalamat.api.result.SModel;
import com.zamanak.shamimsalamat.custom.CustomProgressDialog;
import com.zamanak.shamimsalamat.custom.DividerItemDecoration;
import com.zamanak.shamimsalamat.dialog.OnceTryChanceDialog;
import com.zamanak.shamimsalamat.events.BooleanEventBus;
import com.zamanak.shamimsalamat.interfaces.OnceTryChanceListener;
import com.zamanak.shamimsalamat.utils.FirebaseLogUtils;
import com.zamanak.shamimsalamat.utils.LocationUtils;
...
public class ChanceTreeFragment extends BaseFragmentNew implements View.OnClickListener {
    ...
    @Subscribe
    public void onValidateMTN(Purchase purchase) {
        if (purchase != null) {
            callGetDetailApi();
        }
    }
