package com.zamanak.shamimsalamat.vas;
...
import com.zamanak.shamimsalamat.activity.CharkhoneActivity;
...
import com.zamanak.shamimsalamat.api.request.RequestActivateService;
import com.zamanak.shamimsalamat.api.request.RequestCpRegister;
import com.zamanak.shamimsalamat.dialog.BaseDialogNew;
import com.zamanak.shamimsalamat.utils.FirebaseLogUtils;
import com.zamanak.shamimsalamat.utils.ToastUtils;
...
public class VasDialogNew extends BaseDialogNew implements View.OnClickListener {
    ...
    public static VasDialogNew newInstance(String serviceType, String endPoint,
                                           ...
                                           String bText, String appName,String op) {
    ...
    private void register() {
        ...
        if ("mtn".equals(operator)){
            startActivity(new Intent(getContext() , CharkhoneActivity.class));
        }else{
